...
:::note
To keep [trackball tuning](/trackball-tuning) programming-free, USB is reserved for the tuning app — so ZMK Studio connects over Bluetooth only.
:::
...
5. Flash the new `.uf2` files using [the flashing steps](/firmware/flashing).
